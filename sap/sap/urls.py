...
urlpatterns = [
                  ...
                  path('detallePersona/<int:id>', detallePersona),#url, /,tipoDato y llave primaria
                  path('nuevaPersona', nuevaPersona), #creando una nueva persona
                  path('editarPersona/<int:id>',editarPersona),
                  path('eliminarPersona/<int:id>',eliminarPersona),
              ]
              #+ static(settings.STATIC_URL, sap=settings.STATIC_ROOT)
